const SPOTIT_CACHE = "spotit-shell-v37";
const SHELL_ASSETS = [
  "/manifest.webmanifest?v=37",
  "/assets/brand/spotit-app-logo-v37.png?v=37",
  "/spotit-domain-logo-v37.png?v=37",
  "/spotit-share-logo-v37.png?v=37",
  "/spotit-icon-v37.png?v=37"
];
