const SPOTIT_CACHE = "spotit-shell-v38";
const SHELL_ASSETS = [
  "/manifest.webmanifest?v=38",
  "/assets/brand/spotit-app-logo-v38.png?v=38",
  "/spotit-domain-logo-v38.png?v=38",
  "/spotit-share-logo-v38.png?v=38",
  "/spotit-icon-v38.png?v=38"
];
