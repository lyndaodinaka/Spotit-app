const SPOTIT_CACHE = "spotit-shell-v39";
const SHELL_ASSETS = [
  "/manifest.webmanifest?v=39",
  "/assets/brand/spotit-app-logo-v39.png?v=39",
  "/spotit-domain-logo-v39.png?v=39",
  "/spotit-share-logo-v39.png?v=39",
  "/spotit-icon-v39.png?v=39"
];
