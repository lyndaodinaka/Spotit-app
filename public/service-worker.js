const SPOTIT_CACHE = "spotit-shell-v35";
const SHELL_ASSETS = [
  "/manifest.webmanifest?v=35",
  "/assets/brand/spotit-app-logo-v35.png?v=35",
  "/spotit-domain-logo-v35.png?v=35",
  "/spotit-share-logo-v35.png?v=35",
  "/spotit-icon-v35.png?v=35"
];
