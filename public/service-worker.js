const SPOTIT_CACHE = "spotit-shell-v36";
const SHELL_ASSETS = [
  "/manifest.webmanifest?v=36",
  "/assets/brand/spotit-app-logo-v36.png?v=36",
  "/spotit-domain-logo-v36.png?v=36",
  "/spotit-share-logo-v36.png?v=36",
  "/spotit-icon-v36.png?v=36"
];
