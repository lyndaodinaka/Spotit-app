const SPOTIT_CACHE = "spotit-shell-v30";
const SHELL_ASSETS = [
  "/manifest.webmanifest?v=30",
  "/assets/brand/spotit-app-logo-v30.png?v=30",
  "/spotit-domain-logo-v30.png?v=30",
  "/spotit-share-logo-v30.png?v=30",
  "/spotit-icon-v30.png?v=30"
];
